...
public class Tournament
{
    ...
    public List<Winner> Winners_List { get; set; } = new List<Winner>();
    ...
    public void Match(Team firstTeam, Team secondTeam, string currentcycleDestinatination, string cycleDestination)
    {
        ...
        Console.WriteLine($"\nGra {firstTeam.Name} : {secondTeam.Name} w procesie");
        Thread.Sleep(100);
        ...
        lock (_lock)
        {
            ...
            {
                Console.WriteLine($"#{i}   --    {match.TeamsScores[i][firstTeam.Name]} : " +
                                  $"{match.TeamsScores[i][secondTeam.Name]}   --    ");
            }
        }
    }
    
    // A method for optimizing process of getting the information about the matches in tournament
    ...
    public void StartTournament()
    {
        ...
        foreach (Team team in TeamScheduleInfo["prizers"])
        {
            ...
            Winners_List.Add(new Winner());
            Winners_List[^1].Id = team.Id;
            Winners_List[^1].Team = team;
            Winners_List[^1].Place = team.TeamTournamentPlace;
            Winners_List[^1].TournamentId = Id;
        }
    }
}